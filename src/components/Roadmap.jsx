...
function Roadmap() {
    return (
        <div className="flex flex-col items-center my-20"> 
            <h1 className="text-4xl px-16 pb-1">Roadmap</h1>
            <div className="bg-roadmap bg-no-repeat bg-50% bg-center flex flex-wrap flex-col items-center justify-center py-12 w-full">
