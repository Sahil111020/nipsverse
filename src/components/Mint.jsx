...
function Mint() {
    return (
        <div className="flex justify-center w-full h-auto font-poppins my-10">
            <div id="mintbg" className="bg-secondary h-5/6 md:h-auto md:py-8 w-5/6 xl:w-9/12 2xl:w-8/12 grid grid-flow-row md:grid-flow-col justify-evenly items-center">
                <div className="flex flex-col justify-center items-center md:items-start md:ml-7">
                    ...
                    <div className="inline-flex items-center justify-evenly md:justify-start w-full">
                        ...
                        <button type="submit" className="h-12 px-6 py-2 text-xl text-indigo-100 tracking-widest bg-tertiory rounded-full shadow-sm">MINT</button>   
                    </div>
