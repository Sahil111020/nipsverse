...
function HeroSection() {
    return (
        <div className="flex flex-col items-center mt-12 font-poppins" id="about" >
            <div className="flex flex-col items-center mt-14" data-aos="fade-right">
            ...
            <div data-aos="fade-right" className="tracking-wide flex flex-col items-center text-center w-auto md:w-5/6 xl:w-9/12 p-5 md:p-10 xl:p-8 2xl:w-8/12 h-auto rounded-lg bg-primary bg-opacity-60 text-gray-100">
