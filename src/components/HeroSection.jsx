    ...
    return (
        <div className="flex flex-col items-center mt-12 font-poppins" id="about">
            <div className="flex flex-col items-center mt-14">
                <h1 className="text-3xl font-press-start md:text-4xl xl:text-5xl">WELCOME</h1>
                <h2 className="text-lg font-press-start md:text-xl">TO THE </h2>
